...
const CreditCard = ({name, number, date, ccv, rotate}) => {
  ...
  return (
    <View
      style={[styles.container, isRotate && styles.cardContainer, {transform: [{rotateY: `${scale}deg`}]}]}>
      <View style={styles.content}>
        {!isRotate ? (
          <View>
            <View style={styles.firstSection}>
              <View style={styles.images}>
                <Image style={styles.firstImage} source={require('../../../assets/chip.png')} />
                <Image style={styles.secondImage} source={require('../../../assets/conectless.png')} />
              </View>
              <Text style={styles.creditCard}>Credit Card</Text>
            </View>
            <Text style={styles.number}>{defaultCreditCard(number)}</Text>
            <View style={styles.secondSection}>
              <Text style={styles.name}>{name === '' ? 'YOUR NAME HERE' : name}</Text>
              <View>
          ...
          <View>
            ...
            <View style={styles.ccvContent}>
              ...
              <Text style={[styles.ccv, {transform: [{rotateY: `${scale}deg`}]}]}>
